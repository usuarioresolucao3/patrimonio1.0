...
public class DBCampus extends DML {

    
    ConectaBD conectaDB;
    ResultSet resultSet = null;
    
    private static final String tabela = "campus";
    ...
    public void update(String colunasValores, int idParametro){
		...
		try{
			...
			String query = "UPDATE "+tabela+" SET "+colunasValores+" WHERE id = "+idParametro+"";
    ...
    public void delete(int id){
		...
		try{
			int retornoQuery = conectaDB.getStatement().executeUpdate("DELETE FROM "+tabela+" WHERE id = "+ id +"" );
