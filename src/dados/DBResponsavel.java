...
public class DBResponsavel extends DML {

    
    ConectaBD conectaDB;
    ResultSet resultSet = null;
    
    private static final String tabela = "responsavel";
    
    public DBResponsavel(){
    ...
    public void update(String colunasValores, int idParametro){
		...
		try{
			...
			String query = "UPDATE "+tabela+" SET "+colunasValores+" WHERE siape = "+idParametro+"";
    ...
    public void delete(int id){
		...
		try{
			int retornoQuery = conectaDB.getStatement().executeUpdate("DELETE FROM "+tabela+" WHERE siape = "+ id +"" );
