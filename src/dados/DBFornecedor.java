...
public class DBFornecedor extends DML {
    ...
    public void update(String colunasValores, int idParametro){
		...
		try{
			...
			String query = "UPDATE "+tabela+" SET "+colunasValores+" WHERE cnpj = "+idParametro+"";
    ...
    public void delete(int id){
		...
		try{
			int retornoQuery = conectaDB.getStatement().executeUpdate("DELETE FROM "+tabela+" WHERE cnpj = "+ id +"" );
